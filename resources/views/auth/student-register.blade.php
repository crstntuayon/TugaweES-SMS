...
<head>
    <meta charset="UTF-8">
    <title>Student Registration | Tugawe ES</title>
...
<div class="w-full max-w-2xl backdrop-blur-xl bg-white/90 border border-white/40 rounded-3xl shadow-2xl p-8 md:p-10 animate-slide-up">
    ...
    <div class="text-center mb-8">
        ...
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800 tracking-tight">Student Management System</h1>
        <p class="text-sm text-gray-500 mt-1">Tugawe Elementary School</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <x-text-input id="first_name" name="first_name" class="mt-1 block w-full rounded-xl border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" required />
                <x-input-error :messages="$errors->get('first_name')" class="mt-1" />
            </div>

            <div>
                <x-input-label for="middle_name" value="Middle Name (optional)" />
                <x-text-input id="middle_name" name="middle_name" class="mt-1 block w-full rounded-xl border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" />
                <x-input-error :messages="$errors->get('middle_name')" class="mt-1" />
            </div>

            <div>
                <x-input-label for="last_name" value="Last Name" />
                <x-text-input id="last_name" name="last_name" class="mt-1 block w-full rounded-xl border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" required />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <x-text-input id="suffix" name="suffix" class="mt-1 block w-full rounded-xl border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" placeholder="Jr., III" />
        ...
        <div>
            ...
            <input type="file" name="photo" id="photo" class="mt-1 block w-full text-sm text-gray-600" accept="image/*">
