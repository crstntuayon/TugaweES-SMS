...
<div class="w-full max-w-xl">
    ...
    <div class="bg-white rounded-3xl shadow-2xl p-6 mb-6 animate-slideDown">
        <h1 class="text-3xl font-bold text-gray-800 text-center">Edit Teacher</h1>
        <p class="text-gray-500 text-center mt-1">Update teacher account information</p>
    </div>
    ...
    <div class="bg-white rounded-3xl shadow-2xl p-8 space-y-6 animate-fadeIn">
        <form method="POST" action="{{ route('admin.teachers.update', $teacher) }}" class="space-y-5">
            ...
            <!-- Password (optional) -->
            <div>
                <label class="block text-gray-700 font-medium mb-1">Password (leave blank to keep current)</label>
